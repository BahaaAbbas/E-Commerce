...
const CategoryWiseProductDisplay = ({
  ...
  return (
    <div className='container mx-auto px-4 my-6 relative'>
        ...
        className='transition-all grid grid-cols-[repeat(auto-fit,minmax(300px,320px))] justify-between  md:gap-6 overflow-x-scroll scrollbar-none'>
                ...
                (
                    data.map((product,index)=> {
                        return (
                            <Link 
                            onClick={scrollTop}
                            to={'/product/'+product._id} className='w-full min-w-[280px]  md:min-w-[320px] max-w-[280px]  md:max-w-[320px]  bg-white rounded shadow-md '>
